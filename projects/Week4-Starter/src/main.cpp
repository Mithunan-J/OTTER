...
int main() {
	...
	glm::mat4 transform = glm::mat4(1.0f);//transform for first object
	glm::mat4 transform2 = glm::mat4(1.0f);//transform for second object
	glm::mat4 transform3 = glm::mat4(1.0f);//transform for third object
